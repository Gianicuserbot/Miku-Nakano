    ...
    inline_help_dicts = [
        {
            ...
            "thumb_urL": "https://telegra.ph//file/f520ec3057aa6cdc816ac.jpg",
            "keyboard": ".spb ",
        },
        {
            "title": "Account info on Doraemon",
            "description": "Look up a Telegram account in Doraemon database",
            "message_text": "Click the button below to look up a person in Doraemon database using their Telegram ID",
            "thumb_urL": "https://telegra.ph//file/5a55229df83a94050f826.jpg",
            "keyboard": ".info ",
        },
        {
            "title": "About",
            "description": "Know about Doraemon",
            "message_text": "Click the button below to get to know about Doraemon.",
            "thumb_urL": "https://telegra.ph//file/637f29bf6a42e824da699.jpg",
            "keyboard": ".about ",
        },
        {
            "title": "Help",
            ...
            "thumb_urL": "https://telegra.ph//file/bf7bc48ecfbe795bc92e4.jpg",
            "keyboard": ".help ",
        },
        {
            "title": "Anilist",
            ...
            "thumb_urL": "https://telegra.ph//file/d096dd0ac2ebf3b1287a5.jpg",
            "keyboard": ".anilist ",
        },
        {
            "title": "Paste",
            ...
            "thumb_urL": "https://telegra.ph//file/282e8f1e28f091a18a6f6.jpg",
            "keyboard": ".paste ",
        },
    ]
...
def inlineinfo(query: str, update: Update, context: CallbackContext) -> None:
    ...
    results = [
        InlineQueryResultArticle(
            id=str(uuid4()),
            thumb_url="https://telegra.ph//file/d1f9c2c30de66cdc7ac67.jpg",
...
def about(query: str, update: Update, context: CallbackContext) -> None:
    ...
    results.append(
        InlineQueryResultPhoto(
            ...
            thumb_url="https://telegra.ph//file/282e8f1e28f091a18a6f6.jpg",
            photo_url="https://telegra.ph//file/637f29bf6a42e824da699.jpg",
            caption=about_text,
...
def help(query: str, update: Update, context: CallbackContext) -> None:
    ...
    results.append(
        InlineQueryResultPhoto(
            ...
            title="Help Commands",
            thumb_url="https://telegra.ph//file/d096dd0ac2ebf3b1287a5.jpg",
            photo_url="https://telegra.ph//file/282e8f1e28f091a18a6f6.jpg",
            caption=help_text,
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=kb,
        )
